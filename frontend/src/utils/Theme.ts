export default {
    theme: {
        navbar: {
            base: 'border-neutral-200 bg-white border-2 border-t-0 px-2 py-4 dark:border-neutral-900 dark:bg-neutral-800 sm:px-4 shadow-lg shadow-neutral-800 bg-gradient bg-gradient-to-r from-amber-900/25 via-neutral-800 to-neutral-800 z-10',
            rounded: {
                on: '',
                off: '',
            },
